...
export default class Editpeople extends Component 
{
  constructor(props) {
    super(props)
        ...
        this.get_job_list_dropdown = this.get_job_list_dropdown.bind(this);
        this.get_people_record = this.get_people_record.bind(this);
    ...
    const isVaild = this.user_validation();
     ...
     if(isVaild)
     {
         this.setState({disabled: true});
          ...
          axios.post(ADMIN_API_URL+'update_people', formdata,{
...
async get_job_list_dropdown()
 {
     await axios.post(ADMIN_API_URL+'list_job_title',{},{
          ...
          .then((response) => 
          {
            console.log('yes may  be this thing waitng......1....');
 ...
 {
    const get_job_list = await this.get_job_list_dropdown();
    const getrecord = await this.get_people_record();
 }
