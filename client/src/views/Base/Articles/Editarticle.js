    ...
    const isVaild = this.user_validation();
     ...
     if(isVaild)
     {
         ...
         console.log(this.state);
            ...
            axios.post(ADMIN_API_URL+'update_articles', pass_obj,{
...
{
    const edit_article_data = await axios.post(ADMIN_API_URL+'edit_articles',{'t_id':this.props.match.params.id},{
        headers :  token_header()
        }) 
        .then((response) => 
        {
        ...
        if(edit_article_data.data.success==1)
        {
            var obj_value = edit_article_data.data.data;
            ...
            toast.success(edit_article_data.data.message.message,{ autoClose: 1000 });
            this.props.history.push(MODULE_REDIRECT_URL);
        }
